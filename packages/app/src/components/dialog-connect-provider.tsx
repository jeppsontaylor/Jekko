import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@jekko-ai/sdk/v2/client"
import { Button } from "@jekko-ai/ui/button"
import { useDialog } from "@jekko-ai/ui/context/dialog"
import { Dialog } from "@jekko-ai/ui/dialog"
import { Icon } from "@jekko-ai/ui/icon"
import { IconButton } from "@jekko-ai/ui/icon-button"
import { List, type ListRef } from "@jekko-ai/ui/list"
import { ProviderIcon } from "@jekko-ai/ui/provider-icon"
import { Spinner } from "@jekko-ai/ui/spinner"
import { TextField } from "@jekko-ai/ui/text-field"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "jekko"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.jekkoZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.jekkoZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.jekkoZen.visit.prefix")}
                <Link href="https://jekko.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.jekkoZen.visit.link")}
                </Link>
                {language.t("provider.connect.jekkoZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
