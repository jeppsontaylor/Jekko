...
beforeAll(async () => {
  ...
  mock.module("@jekko-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@jekko-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@jekko-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@jekko-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
