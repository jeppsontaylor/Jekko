...
import { base64Encode } from "@jekko-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@jekko-ai/ui/resize-handle"
import { Button } from "@jekko-ai/ui/button"
import { IconButton } from "@jekko-ai/ui/icon-button"
import { Tooltip } from "@jekko-ai/ui/tooltip"
import { DropdownMenu } from "@jekko-ai/ui/dropdown-menu"
import { Dialog } from "@jekko-ai/ui/dialog"
import { getFilename } from "@jekko-ai/core/util/path"
import { Session, type Message } from "@jekko-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@jekko-ai/ui/toast"
...
import { retry } from "@jekko-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@jekko-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://jekko.ai/desktop-feedback")}
      renderPanel={() =>
