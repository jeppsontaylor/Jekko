...
export const dict = {
  ...
  "dialog.provider.jekko.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.jekko.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.jekkoGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Jekko tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Jekko'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.jekkoZen.line1":
    "Jekko Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.jekkoZen.visit.prefix": "",
  "provider.connect.jekkoZen.visit.link": "jekko.ai/zen",
  "provider.connect.jekkoZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Jekko'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Jekko'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler jekko.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Jekko sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Jekko'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Jekko ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (jekko.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Jekko henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Jekko ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Jekko Masaüstü",
  ...
  "settings.desktop.wsl.description": "Jekko sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Jekko'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Jekko'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Jekko'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Jekko'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Jekko başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Jekko'un en son sürümünü kullanıyorsunuz.",
