export const dict = {
  ...
  "dialog.provider.jekko.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.jekko.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.jekkoGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Jekko",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Jekko.",
  ...
  "provider.connect.jekkoZen.line1":
    "Jekko Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.jekkoZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.jekkoZen.visit.prefix": "Besøg ",
  "provider.connect.jekkoZen.visit.link": "jekko.ai/zen",
  "provider.connect.jekkoZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Jekko.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Jekko.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i jekko.json",
  ...
  "dialog.server.description": "Skift hvilken Jekko-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Jekko ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Jekko-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (jekko.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Jekko understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Jekko inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Jekko-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Jekko",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Jekko ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Jekko følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Jekko er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Jekko starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Jekko.",
