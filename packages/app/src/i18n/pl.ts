export const dict = {
  ...
  "dialog.provider.jekko.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.jekko.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.jekkoGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Jekko",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Jekko.",
  ...
  "provider.connect.jekkoZen.line1":
    "Jekko Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.jekkoZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.jekkoZen.visit.prefix": "Odwiedź ",
  "provider.connect.jekkoZen.visit.link": "jekko.ai/zen",
  "provider.connect.jekkoZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Jekko.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Jekko.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w jekko.json",
  ...
  "dialog.server.description": "Przełącz serwer Jekko, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Jekko ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Jekko",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (jekko.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Jekko zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Jekko",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Jekko na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Jekko ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Jekko.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Jekko",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Jekko.",
