export const dict = {
  ...
  "dialog.provider.jekko.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.jekko.tagline": "Modelos optimizados y fiables",
  "dialog.provider.jekkoGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Jekko",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Jekko.",
  ...
  "provider.connect.jekkoZen.line1":
    "Jekko Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.jekkoZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.jekkoZen.visit.prefix": "Visita ",
  "provider.connect.jekkoZen.visit.link": "jekko.ai/zen",
  "provider.connect.jekkoZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Jekko.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Jekko.",
  ...
  "dialog.plugins.empty": "Plugins configurados en jekko.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Jekko se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Jekko ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Jekko",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (jekko.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Jekko no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Jekko incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Jekko dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Jekko",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Jekko en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Jekko sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Jekko.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Jekko",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Jekko.",
