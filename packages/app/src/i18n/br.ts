export const dict = {
  ...
  "dialog.provider.jekko.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.jekko.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.jekkoGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Jekko",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Jekko.",
  ...
  "provider.connect.jekkoZen.line1":
    "Jekko Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.jekkoZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.jekkoZen.visit.prefix": "Visite ",
  "provider.connect.jekkoZen.visit.link": "jekko.ai/zen",
  "provider.connect.jekkoZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Jekko.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Jekko.",
  ...
  "dialog.plugins.empty": "Plugins configurados em jekko.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Jekko este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Jekko ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Jekko",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (jekko.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Jekko ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Jekko inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Jekko dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Jekko",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Jekko aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Jekko segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Jekko é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Jekko iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Jekko.",
