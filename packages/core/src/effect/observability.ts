...
import { ensureProcessMetadata } from "../util/jekko-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "jekko.client": Flag.JEKKO_CLIENT,
      "jekko.process_role": processMetadata.processRole,
      "jekko.run_id": processMetadata.runID,
