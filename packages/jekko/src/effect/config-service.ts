 ...
 *   "@jekko/ServerAuthConfig",
 *   {
 *     password: Config.string("JEKKO_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("JEKKO_SERVER_USERNAME").pipe(Config.withDefault("jekko")),
 *   },
 * ) {}
 *
