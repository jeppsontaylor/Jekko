import type * as SDK from "@jekko-ai/sdk/v2"
...
const disabled = process.env["JEKKO_DISABLE_SHARE"] === "true" || process.env["JEKKO_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@jekko/ShareNext") {}
