...
>()("@jekko/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@jekko/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.JEKKO_WORKSPACE_ID ? WorkspaceID.make(Flag.JEKKO_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-jekko-directory"] || process.cwd()
}
