...
export const RootHttpApi = HttpApi.make("jekko-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("jekko-instance")
...
export const JekkoHttpApi = HttpApi.make("jekko")
