...
export const SessionPaths = {
  ...
  [sessionTaskKey]: `${root}/:sessionID/${sessionTaskKey}`,
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Jekko sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Jekko session.",
          }),
        ),
...
HttpApiEndpoint.get("pending", SessionPaths.pending, {
        ...
        HttpApiEndpoint.get(sessionTaskKey, SessionPaths[sessionTaskKey], {
          ...
          OpenApi.annotations({
            identifier: join2("session.", sessionTaskKey),
            summary: "Get session pending items",
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Jekko session for interacting with AI assistants and managing conversations.",
          }),
        ),
