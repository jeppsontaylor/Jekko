...
const LegacyComponentDescriptions = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for jekko serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw = OpenApi.fromApi(JekkoHttpApi) as unknown as OpenApiSpec
...
export const PublicApi = JekkoHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "jekko",
    version: "1.0.0",
