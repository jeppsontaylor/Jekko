...
import { Identifier } from "@jekko-ai/core/util/identifier"
import { NonNegativeInt, withStatics } from "@/util/schema"
import { Global } from "@jekko-ai/core/global"
import { AppFileSystem } from "@jekko-ai/core/filesystem"

export const OAUTH_DUMMY_KEY = "jekko-oauth-mock-key"
...
export class Service extends Context.Service<Service, Interface>()("@jekko/v2/Auth") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const load: () => Effect.Effect<Writable, AuthError> = Effect.fnUntraced(function* () {
      if (process.env.JEKKO_AUTH_CONTENT) {
        try {
          return JSON.parse(process.env.JEKKO_AUTH_CONTENT)
        } catch {}
      }
