...
import { sanitizedProcessEnv } from "@jekko-ai/core/util/jekko-process"
...
export class Service extends Context.Service<Service, Interface>()("@jekko/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".jekko")) continue
