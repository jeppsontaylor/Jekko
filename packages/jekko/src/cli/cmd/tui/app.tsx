...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.JEKKO_DISABLE_TERMINAL_TITLE) return

    if (route.data.type === "home") {
      renderer.setTerminalTitle("Jekko")
      return
    }
  ...
  return (
    <box
      ...
      onMouseUp={Flag.JEKKO_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? undefined : () => Selection.copy(renderer, toast)}
    >
