...
<html>
  <head>
    <title>Jekko - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Jekko.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>Jekko - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput): Promise<Hooks> {
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "jekko"
      output.headers["User-Agent"] = `jekko/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
