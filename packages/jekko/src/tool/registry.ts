...
export class Service extends Context.Service<Service, Interface>()("@jekko/ToolRegistry") {}
      ...
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        return {
          ...
          builtin: [
            ...
            tool.patch,
            ...tool.daemon,
            ...(Flag.JEKKO_EXPERIMENTAL_LSP_TOOL ? [tool.lsp] : []),
            ...(Flag.JEKKO_EXPERIMENTAL_PLAN_MODE && Flag.JEKKO_CLIENT === "cli" ? [tool.plan] : []),
          ],
          task: tool.task,
          read: tool.read,
        }
    ...
    const tools: Interface["tools"] = Effect.fn("ToolRegistry.tools")(function* (input) {
      const filtered = (yield* all()).filter((tool) => {
        if (tool.id === WebSearchTool.id) {
          return input.providerID === ProviderID.jekko || Flag.JEKKO_ENABLE_EXA
        }
