...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders JEKKO_CALLER", () => {
    process.env["JEKKO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode JEKKO_CALLER", () => {
    process.env["JEKKO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown JEKKO_CALLER", () => {
    process.env["JEKKO_CALLER"] = "unknown"
