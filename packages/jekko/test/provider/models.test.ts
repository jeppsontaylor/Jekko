...
// test/preload.ts pins JEKKO_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.JEKKO_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.JEKKO_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.JEKKO_MODELS_PATH = undefined
  Flag.JEKKO_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.JEKKO_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.JEKKO_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
