...
const originalOpencodePort = process.env.JEKKO_EDITOR_SSE_PORT

afterEach(() => {
  process.env.CLAUDE_CODE_SSE_PORT = originalClaudePort
  process.env.JEKKO_EDITOR_SSE_PORT = originalOpencodePort
})
...
test("useEditorContext connects with JEKKO_EDITOR_SSE_PORT", async () => {
  await using tmp = await tmpdir()
  process.env.CLAUDE_CODE_SSE_PORT = undefined
  process.env.JEKKO_EDITOR_SSE_PORT = "4020"
