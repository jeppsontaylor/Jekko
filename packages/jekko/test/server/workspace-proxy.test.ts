...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips jekko-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-jekko-directory"]).toBeUndefined()
      expect(forwarded["x-jekko-workspace"]).toBeUndefined()
