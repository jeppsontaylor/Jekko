...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips jekko-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-jekko-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-jekko-directory")).toBeNull()
      expect(result.get("x-jekko-workspace")).toBeNull()
