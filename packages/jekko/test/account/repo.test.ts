  ...
  Effect.gen(function* () {
    ...
    yield* AccountRepo.Service.use((r) =>
      r.persistAccount({
        ...
        email: "test@example.com",
        url: "https://control.example.com",
        token: AccessToken.make("old_token"),
    ...
    yield* AccountRepo.Service.use((r) =>
      r.persistToken({
        accountID: id,
        token: AccessToken.make("new_token"),
