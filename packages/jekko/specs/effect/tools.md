...
Practical reference for the current tool-migration state in `packages/jekko`.
...
Tool tests should use the existing Effect helpers in `packages/jekko/test/lib/effect.ts`:
