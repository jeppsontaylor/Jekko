...
import compareVideo from "../../asset/lander/jekko-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/jekko-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="jekko:auth" content={loggedin() ? "true" : "false"} />
