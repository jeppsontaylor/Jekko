const dict: Record<string, string> = {
  "session.pending.title": "Todos",
  "session.pending.collapse": "Collapse todos",
  "session.pending.expand": "Expand todos",
  "prompt.loading": "Loading prompt...",
  "prompt.default_value.normal": "Ask anything...",
  "prompt.default_value.simple": "Ask anything...",
  "prompt.default_value.shell": "Run a shell command... {{example}}",
  "prompt.default_value.summarizeComment": "Summarize this comment",
  "prompt.default_value.summarizeComments": "Summarize these comments",
