export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Jekko",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Jekko. ¿Quieres instalarla y reiniciar?",
