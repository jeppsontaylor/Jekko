...
const releaseId = process.env.JEKKO_RELEASE
if (!releaseId) throw new Error("JEKKO_RELEASE is required")

const version = process.env.JEKKO_VERSION
if (!version) throw new Error("JEKKO_VERSION is required")
...
const macxTarGz = "jekko-desktop-mac-x64.app.tar.gz"
const macaTarGz = "jekko-desktop-mac-arm64.app.tar.gz"
