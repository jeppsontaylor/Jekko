import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@jekko-ai/sdk/v2"
import { SessionTurn } from "@jekko-ai/ui/session-turn"
import { SessionReview } from "@jekko-ai/ui/session-review"
import { DataProvider } from "@jekko-ai/ui/context"
import { FileComponentProvider } from "@jekko-ai/ui/context/file"
import { WorkerPoolProvider } from "@jekko-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@jekko-ai/ui/logo"
import { IconButton } from "@jekko-ai/ui/icon-button"
import { ProviderIcon } from "@jekko-ai/ui/provider-icon"
import { iife } from "@jekko-ai/core/util/iife"
...
import { Tabs } from "@jekko-ai/ui/tabs"
import { MessageNav } from "@jekko-ai/ui/message-nav"
import { FileSSR } from "@jekko-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@jekko-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/jekko-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Jekko</Title>
              </Show>
              <Meta name="description" content="jekko - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/jekko"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
