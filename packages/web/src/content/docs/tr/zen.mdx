---
title: Zen
description: jekko tarafından sağlanan seçilmiş modeller listesi.
---
...
Jekko Zen, Jekko ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

:::note
Jekko Zen şu anda beta olarak mevcut.
:::

Zen, Jekko'daki diğer sağlayıcılar gibi çalışır. Jekko Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Jekko kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Jekko ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Jekko Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Jekko Zen, Jekko'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Jekko Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Jekko Zen'i seçin ve API anahtarınızı yapıştırın.
...
Jekko yapılandırmanızdaki [model id](/docs/config/#models) `jekko/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `jekko/gpt-5.5` kullanırsınız.
...
- MiniMax M2.5 Free, sınırlı bir süre için Jekko'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling 2.6 Flash Free, sınırlı bir süre için Jekko'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Hy3 Preview Free, sınırlı bir süre için Jekko'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için Jekko'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Jekko'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Jekko Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Jekko ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
