---
title: Paylasim
description: jekko konusmalarini genel baglantilarla paylasin.
---

jekko'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda jekko:
...
jekko, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak jekko manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `jekko.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda jekko kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
