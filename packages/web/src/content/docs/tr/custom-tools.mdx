---
title: Özel Araçlar
description: LLM'un jekko'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. jekko'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.jekko/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/jekko/tools/` içine yerleştirerek.
