...
Erstellen Sie `.jekko/commands/test.md`:

```md title=".jekko/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Jekko-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Jekko [config](/docs/config):

```json title="jekko.jsonc" {4-12}
{
...
- Global: `~/.config/jekko/commands/`
- Pro Projekt: `.jekko/commands/`

```markdown title="~/.config/jekko/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".jekko/commands/component.md"
---
...
```md title=".jekko/commands/create-file.md"
---
...
```md title=".jekko/commands/analyze-coverage.md"
---
...
```md title=".jekko/commands/review-changes.md"
---
...
```md title=".jekko/commands/review-component.md"
---
...
Jekko enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
