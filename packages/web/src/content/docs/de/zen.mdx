---
title: Zen
description: Kuratierte Modellliste direkt von Jekko.
---
...
Jekko Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Jekko-Team bereitgestellt wird.

:::note
Jekko Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Jekko. Du meldest dich bei Jekko Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Jekko zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Jekko funktionieren.
:::
...
Jekko Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Jekko Zen funktioniert wie jeder andere Provider in Jekko.

1. Du meldest dich bei **<a href={console}>Jekko Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Jekko Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Jekko-Konfiguration verwendet das Format `jekko/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `jekko/gpt-5.5` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf Jekko verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ling 2.6 Flash Free ist für begrenzte Zeit auf Jekko verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Preview Flash Free ist für begrenzte Zeit auf Jekko verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf Jekko verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Jekko verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Jekko Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Jekko auch jeden anderen Provider zu verwenden.
