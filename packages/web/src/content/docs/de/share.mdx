---
title: Teilen
description: Teile Jekko-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Jekko-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Jekko Folgendes:
...
Jekko hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Jekko den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`jekko.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du jekko in deiner Organisation einsetzt.
