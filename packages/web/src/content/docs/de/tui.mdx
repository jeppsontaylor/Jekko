---
title: TUI
description: Arbeite mit Jekko in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Jekko bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Jekko die TUI im aktuellen Verzeichnis.
...
In der Jekko-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Jekko hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Dies ist getrennt von `jekko.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `JEKKO_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
