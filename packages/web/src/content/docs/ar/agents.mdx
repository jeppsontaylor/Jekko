...
يوجد نوعان من الوكلاء في Jekko: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Jekko مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Jekko مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Jekko مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `jekko.json`:
...
- عام: `~/.config/jekko/agents/`
- لكل مشروع: `.jekko/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Jekko القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Jekko العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Jekko الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Jekko Zen](/docs/zen)، فستستخدم `jekko/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `jekko models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/jekko).
:::
