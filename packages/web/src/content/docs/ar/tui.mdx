---
title: TUI
description: استخدام واجهة المستخدم TUI في Jekko.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Jekko واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Jekko إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Jekko في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Jekko. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Jekko. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Jekko.
...
استخدم `JEKKO_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
