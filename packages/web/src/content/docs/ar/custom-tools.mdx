...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في jekko.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في jekko مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.jekko/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/jekko/tools/`.
