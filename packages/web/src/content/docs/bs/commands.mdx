...
Kreiraj `.jekko/commands/test.md`:
...
Možete dodati prilagođene komande kroz Jekko konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Jekko [config](/docs/config):
...
- Globalno: `~/.config/jekko/commands/`
- Po projektu: `.jekko/commands/`
...
Jekko uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
