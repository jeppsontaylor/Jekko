---
title: TUI
description: Korištenje korisničkog interfejsa Jekko terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Jekko pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Jekko pokreće TUI za trenutni direktorij.
...
Kada koristite Jekko TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Jekko. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Jekko. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `jekko.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `JEKKO_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
