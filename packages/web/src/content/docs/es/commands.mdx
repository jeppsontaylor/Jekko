...
Puede agregar comandos personalizados a través de la configuración Jekko o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Jekko [config](/docs/config):
...
jekko incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
