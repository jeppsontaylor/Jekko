---
title: TUI
description: Usando la interfaz de usuario del terminal Jekko.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Jekko proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Jekko se inicia TUI para el directorio actual.
...
Cuando utilice Jekko TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Jekko. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `jekko.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `JEKKO_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
