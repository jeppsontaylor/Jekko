...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Jekko:
...
- ระดับผู้ใช้ (Global): `~/.config/jekko/commands/`
- ระดับโปรเจ็กต์: `.jekko/commands/`
...
Jekko มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
