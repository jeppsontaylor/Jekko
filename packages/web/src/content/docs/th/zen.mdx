---
title: เซน
description: รายการโมเดลที่คัดสรรโดย Jekko
---
...
Jekko Zen คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม Jekko

:::note
Jekko Zen อยู่ในช่วงเบต้าในขณะนี้
:::

Zen ทำงานเหมือน provider อื่น ๆ ใน Jekko คุณล็อกอินเข้า Jekko Zen แล้วรับ
...
:::tip
เราได้ทดสอบโมเดลและ provider ที่คัดมาแล้วกลุ่มหนึ่งซึ่งทำงานได้ดีกับ Jekko
:::
...
Jekko Zen คือ AI gateway ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## วิธีการทำงาน

Jekko Zen ทำงานเหมือน provider อื่น ๆ ใน Jekko

1. คุณลงชื่อเข้าใช้ **<a href={console}>Jekko Zen</a>** เพิ่มรายละเอียดการเรียกเก็บเงิน แล้วคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก Jekko Zen แล้ววาง API key ของคุณ
...
[model id](/docs/config/#models) ใน Jekko config ของคุณใช้รูปแบบ `jekko/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `jekko/gpt-5.5` ใน config ของคุณ
...
- MiniMax M2.5 Free เปิดให้ใช้บน Jekko ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Ling 2.6 Flash Free เปิดให้ใช้บน Jekko ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Hy3 Preview Free เปิดให้ใช้บน Jekko ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Nemotron 3 Super Free เปิดให้ใช้บน Jekko ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Big Pickle เป็น stealth model ที่ใช้งานฟรีบน Jekko ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
...
เราสร้าง Jekko Zen ขึ้นมาเพื่อ:
...
4. ทำให้เกิด **no lock-in** โดยให้คุณใช้มันร่วมกับ coding agent อื่น ๆ ได้ และยังเปิดให้คุณใช้ provider อื่น ๆ กับ Jekko ได้เสมอ
