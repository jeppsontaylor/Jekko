---
title: Deling
description: Del dine Jekko-samtaler.
---

Delingsfunksjonen i Jekko lar deg lage offentlige lenker til dine Jekko-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Jekko støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Jekko manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `jekko.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av jekko i organisasjonen din.
