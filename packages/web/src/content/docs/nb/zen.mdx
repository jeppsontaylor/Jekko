---
title: Zen
description: Utvalgt liste over modeller levert av Jekko.
---
...
Jekko Zen er en liste over testede og verifiserte modeller levert av Jekko-teamet.

:::note
Jekko Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i Jekko. Du logger inn på Jekko Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Jekko.
:::
...
Jekko Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Jekko Zen fungerer som enhver annen leverandør i Jekko.

1. Du logger inn på **<a href={console}>Jekko Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Jekko Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Jekko-konfigurasjonen din
bruker formatet `jekko/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `jekko/gpt-5.5` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Jekko i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling 2.6 Flash Free er tilgjengelig på Jekko i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Hy3 Preview Free er tilgjengelig på Jekko i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Jekko i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Jekko i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Jekko også.
