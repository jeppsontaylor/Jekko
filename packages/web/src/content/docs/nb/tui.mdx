---
title: TUI
description: Bruke jekko-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Jekko gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Jekko starter TUI for gjeldende katalog.
...
Når du bruker Jekko TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Jekko. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Jekko. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `jekko.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `JEKKO_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
