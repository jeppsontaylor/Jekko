...
description: Lag verktøy som LLM kan kalle inn Jekko.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Jekko sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.jekko/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/jekko/tools/`.
