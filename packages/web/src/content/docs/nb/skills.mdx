...
Agentferdigheter lar Jekko oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går jekko opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
jekko viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `jekko.json`:
