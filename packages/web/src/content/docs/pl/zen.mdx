---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Jekko.
---
...
Jekko Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Jekko.

:::note
Jekko Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w Jekko. Logujesz się do Jekko Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Jekko.
:::
...
Jekko Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Jekko Zen działa jak każdy inny dostawca w Jekko.

1. Logujesz się do **<a href={console}>Jekko Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Jekko Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Jekko używa formatu
`jekko/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`jekko/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w Jekko przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w Jekko przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w Jekko przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w Jekko przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Jekko przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Jekko także dowolnego innego dostawcy.
