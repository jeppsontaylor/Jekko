...
Możesz zdefiniować polecenia w `jekko.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji jekko:
...
- Globalnie: `~/.config/jekko/commands/`
- Na projekt: `.jekko/commands/`
...
jekko zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
