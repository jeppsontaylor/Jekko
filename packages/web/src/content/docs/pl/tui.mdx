---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala jekko.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

jekko zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie jekko uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI jekko, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do jekko. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `jekko.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `JEKKO_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
