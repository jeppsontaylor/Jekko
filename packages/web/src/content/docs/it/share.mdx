---
title: Condivisione
description: Condividi le tue conversazioni Jekko.
---

La funzione di condivisione di Jekko ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Jekko:
...
Jekko supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Jekko usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `jekko.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare jekko nella tua organizzazione.
