---
title: Zen
description: Lista curata di modelli fornita da Jekko.
---
...
Jekko Zen è un elenco di modelli testati e verificati forniti dal team di Jekko.

:::note
Jekko Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in Jekko. Accedi a Jekko Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Jekko.
:::
...
Jekko Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Jekko Zen funziona come qualsiasi altro provider in Jekko.

1. Accedi a **<a href={console}>Jekko Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Jekko Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Jekko
usa il formato `jekko/<model-id>`. Per esempio, per GPT 5.5, useresti
`jekko/gpt-5.5` nella tua config.
...
- MiniMax M2.5 Free è disponibile su Jekko per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling 2.6 Flash Free è disponibile su Jekko per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Hy3 Preview Flash Free è disponibile su Jekko per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Jekko per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Jekko per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Jekko.
