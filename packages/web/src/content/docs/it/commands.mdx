...
Puoi aggiungere comandi personalizzati tramite la config di Jekko o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Jekko:
...
- Globale: `~/.config/jekko/commands/`
- Per progetto: `.jekko/commands/`
...
jekko include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
