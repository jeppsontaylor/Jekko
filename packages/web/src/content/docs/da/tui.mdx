---
title: TUI
description: Brug af Jekko-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Jekko giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Jekko starter TUI for den nuværende mappe.
...
Når du bruger Jekko TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Jekko. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `jekko.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `JEKKO_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
