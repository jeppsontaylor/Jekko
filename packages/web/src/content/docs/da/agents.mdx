...
Der er to typer agenter i Jekko; primære agenter og subagenter.
...
Jekko leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Jekko leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Jekko leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `jekko.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Jekko modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Jekko-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Jekko-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Jekko Zen](/docs/zen), vil du bruge `jekko/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `jekko models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/jekko).
:::
