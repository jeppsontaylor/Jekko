...
description: Opret værktøjer, som LLM kan kalde jekko ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med jekkos [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.jekko/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/jekko/tools/`.
