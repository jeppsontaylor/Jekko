---
title: TUI
description: Usando a interface de usuário de terminal jekko.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O jekko fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar jekko inicia o TUI para o diretório atual.
...
Ao usar o TUI do jekko, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao jekko. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do jekko. _Aliases_: `/quit`, `/q`
...
Isso é separado do `jekko.json`, que configura o comportamento do servidor/runtime.
...
Use `JEKKO_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
