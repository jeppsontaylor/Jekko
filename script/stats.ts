...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/neverhuman/jekko/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for neverhuman/jekko...\n")
...
console.log("Fetching npm all-time downloads for jekko-ai...\n")
const npmDownloads = await fetchNpmDownloads("jekko-ai")
