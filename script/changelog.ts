...
Generates UPCOMING_CHANGELOG.md by running the jekko changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for jekko run (default: low)
      --quiet            Suppress jekko command output unless it fails
