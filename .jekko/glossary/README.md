...
Use this folder for locale-specific translation guidance that supplements `.jekko/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/jekko/pull/12345

## Do Not Translate (Locale Additions)

- `Jekko` (preserve casing)
