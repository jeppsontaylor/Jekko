...
- PR #15835: https://github.com/anomalyco/jekko/pull/15835

## Do Not Translate (Locale Additions)

- `Jekko` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `jekko` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Jekko` in prose, `jekko` only for exact technical identifiers
...
- Avoid changing `jekko` to `Jekko` inside commands, URLs, package names, or code literals
