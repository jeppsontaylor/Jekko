...
- PR #10018: https://github.com/anomalyco/jekko/pull/10018
- PR #12935: https://github.com/anomalyco/jekko/pull/12935

## Do Not Translate (Locale Additions)

- `Jekko` (preserve casing in prose; keep `jekko` only in commands, package names, paths, or code)
- `Jekko CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
