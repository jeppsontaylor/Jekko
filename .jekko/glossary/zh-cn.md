...
- PR #13942: https://github.com/anomalyco/jekko/pull/13942

## Do Not Translate (Locale Additions)

- `Jekko` (preserve casing in prose; keep `jekko` only when it is part of commands, package names, paths, or code)
- `Jekko Zen`
- `Jekko CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `jekko` in prose when referring to the product name; use `Jekko`
