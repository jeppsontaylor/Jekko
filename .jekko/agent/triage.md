...
Desktop application and browser-based app issues, including `jekko web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core jekko server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Jekko Zen, Jekko Go, and billing issues.
