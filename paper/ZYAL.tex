...
\begin{figure*}[t]
\centering
\resizebox{\textwidth}{!}{\input{figures/host-control-loop.tex}}
...
\begin{figure*}[t]
\centering
\resizebox{\textwidth}{!}{\input{figures/trust-capability-taint-flow.tex}}
...
\begin{figure*}[t]
\centering
\resizebox{\textwidth}{!}{\input{figures/incubator-tournament.tex}}
...
\inputminted{yaml}{listings/fix-until-green.zyal}

\subsection{Hypothesis Tournament}
\inputminted{yaml}{listings/hypothesis-tournament.zyal}

\subsection{Billion-LOC Monorepo}
\inputminted{yaml}{listings/billion-loc-monorepo.zyal}

\subsection{Fleet Portfolio}
\inputminted{yaml}{listings/fleet-portfolio.zyal}

\subsection{Secure MCP Lockdown}
\inputminted{yaml}{listings/secure-mcp-lockdown.zyal}

\subsection{Evidence Graph Merge}
\inputminted{yaml}{listings/evidence-graph-merge.zyal}

\subsection{Self-Improving Skills}
\inputminted{yaml}{listings/self-improving-skills.zyal}

\subsection{Full-Power Runbook}
\inputminted{yaml}{listings/full-power-runbook.zyal}

\subsection{Jankurai Master Loop}
\inputminted{yaml}{listings/jankurai-master-loop.zyal}

\subsection{Control-Plane Preview}
\inputminted{yaml}{listings/control-plane-preview.zyal}
